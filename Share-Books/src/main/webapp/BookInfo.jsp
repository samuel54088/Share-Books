		...
		<div class="header">
			<nav>
				<ul class="nav nav-pills pull-right">
					...
					<li role="presentation"><a href="identify.jsp">尋找書籍</a></li>
				</ul>
			</nav>
			<h1 class="text-muted">
				<b>Share-Books</b>
	...
	<div class="container">
		<%
			...
			if (OwnerInfoBuf != null) {
				...
				session.setAttribute("ownid", OwnerInfoBuf[0]);

				out.print("<form method=\"POST\" action=\"lend.jsp\">");
				out.print("<input type=\"submit\" value=\"借閱\"></form>");
